       ...
       <div className="flex gap-4   pb-4 overflow-x-auto scrollbar-hide">
        {shortList.data.map((short,key)=>(
          ...
          <div className="relative w-48 h-80 overflow-hidden rounded-lg bg-zinc-900">
             <img src={short.thumbnail[1].url} alt="" className="h-full w-full object-cover transition group-hover:scale-105"  />

              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent-500 p-4">
                <h3 className="text-white text-sm mb-1 line-clamp-2">{short.title}
